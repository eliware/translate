...
A CLI tool for translating locale files for [@eliware/discord](https://github.com/eliware/discord) framework Discord apps. It uses OpenAI to generate translations for all supported Discord locales from a single English source file.
